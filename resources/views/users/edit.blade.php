                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="first_name" class="form-control" id="first_name" aria-describedby="first_name" value="{{ $user->first_name }}">
                            </div>
                            <div class="mb-3">
                                <label for="last_name" class="form-label">{{ __('Apellidos') }}</label>
                                <input type="text" name="last_name" class="form-control" id="last_name" aria-describedby="last_name" value="{{ $user->last_name }}">
                            </div>
                            <div class="mb-3">
                                <label for="departments" class="form-label">{{ __('Departamento') }}</label>
                                <input type="text" name="departments" class="form-control" id="departments" aria-describedby="departments" value="{{ $user->departments }}">
                            </div>
                            <div class="mb-3">
